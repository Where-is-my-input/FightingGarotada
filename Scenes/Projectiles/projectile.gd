...
func setHitboxValues(Stun = 19, StunVector = Vector2(5,0), Damage = 0, AttackType = Global.blockType.MID, Hitstop = 7, Vstun = 1, HitProperty = Global.hitType.PROJECTILE, Blockstun = 10):
	hitbox.stun = Stun
